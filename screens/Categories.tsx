...
export const Categories = () => {
  ...
  const [categories, setCategories] = useState([{id: 1, name: 'Clothes', color: 'green'}])
  ...
  const deleteCategory = (id: any) => {
    ...
    //temporary
    setCategories(oldValues => oldValues.filter(item => item.id !== id))
    //temporary
  };
